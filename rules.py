...
def SetupPyTestSuiteWithDeps(env, sdist_target, *args, **kwargs):
    ...
    # and issue a warning.
    if len(args):
        warnings.warning("Don't pass dependencies as arguments,"
                         "pass them as sdist_depends list instead")
        kwargs['sdist_depends'] = args
    ...
    if 'sdist_depends' in kwargs:
        sdist_depends = env.Flatten(kwargs['sdist_depends'])
